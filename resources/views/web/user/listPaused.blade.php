                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="cs-user-account-holder">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="cs-user-section-title"><h4>Publicaciones Pausadas</h4>
                                        <ul>
                                            <li><a href="#" class="cs-active-btn">Pausados</a>
                                                <ul>
                                                    <li>
                                                        <a href="{{ route('dashboard.listVehiclesExipire') }}">Vencidos</a>
                                                    </li>
                                                    <li><a href="{{ route('dashboard.listVehicles') }}">Activos</a></li>
                                                    <li>
                                ...
                                <ul class="cs-featurelisted-car">
                                                ...
                                                <div class="cs-post-types">
                                                    <div class="cs-post-list">
                                                        ...
                                                        <div class="cs-list">
                                                            ...
                                                            <a href="{{ route('actionItems.play', $listMoto) }}"
                                                               data-toggle="tooltip" data-placement="top"
                                                               title="Activar"><i class="icon-play"></i></a>
                                    ...
                                    @empty
                                        <h4 style="text-align: center">No tienes Publicaciones pausadas</h4>
                                    @endforelse
                                </ul>
                            </div>
                        </div>
