...
<table style="height: 28px; background-color: #f2f2f2; width: 538.5px; margin-left: auto; margin-right: auto;">
    ...
    <tr>
        <td style="width: 528.5px; text-align: left;">
            <p>&nbsp;</p>
            <p style="padding-left: 30px;"><strong>Item pendiente de aprobación</strong></p>
            <p style="padding-left: 30px;">Un administrador evaluará tu publicación <strong>{{ $item->brand->name }} {{ $item->pattern->name }}
                        {{ $item->displacement }}</strong> y en las próximas horas estará visible.
            </p>
            <p style="padding-left: 30px;"><strong>Datos Ingresados:</strong></p>
