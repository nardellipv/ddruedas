...
<table style="height: 28px; background-color: #f2f2f2; width: 538.5px; margin-left: auto; margin-right: auto;">
    ...
    <tr>
        <td style="width: 528.5px; text-align: left;">
            <p>&nbsp;</p>
            <p style="padding-left: 30px;">Hola <strong>{{ $request->name }}</strong>,</p>
            <p style="padding-left: 30px;">Te enviamos los datos solicitados por la moto
            ...
            @if($request->comment)
                <p style="text-align: center;">Tus Comentarios:</p>
